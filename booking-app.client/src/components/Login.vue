<template>
    <div class="frame">
        ...
        <div class="div">
            <p class="p">
                <span class="span">Электронная почта:</span>
            </p>
        ...
        <p class="name-2">
            <span class="text-wrapper-3">Нет аккаунта? </span>
            <span class="text-wrapper-4">Зарегистрироваться</span>
        </p>
    </div>
</template>
